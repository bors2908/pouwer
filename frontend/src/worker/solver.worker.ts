...
import { Challenge, JobType, Sha256PowResultPayload, Task, WorkerInMessage, WorkerOutMessage } from "../lib/types";
...
async function solveSha256(task: Task) {

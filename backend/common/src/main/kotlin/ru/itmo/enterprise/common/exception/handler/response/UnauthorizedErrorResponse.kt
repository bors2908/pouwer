...
data class UnauthorizedErrorResponse(
    ...
    @Schema(
        ...
        example = ru.itmo.enterprise.common.exception.handler.response.UnauthorizedErrorResponse.Companion.CODE
    )
    override val code: String = ru.itmo.enterprise.common.exception.handler.response.UnauthorizedErrorResponse.Companion.CODE
